...
Before cleaning the data we will create a final holdout test so that we can use it to test our final selected model on a completly seoparate and independent data set.
