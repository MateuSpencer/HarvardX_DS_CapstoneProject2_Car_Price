...
```{r log transformation price qqplot, echo=FALSE, fig.height=5, fig.width=5}
...
```{r Residuals Plot, echo=FALSE, fig.height=5, fig.width=5}
...
p <- ggplot(combined_predictions, aes(x = Actual, y = Predicted, color = Model)) +
  geom_point() +
...
```{r Prediction Error Plot, echo=FALSE, fig.height=5, fig.width=5}
p <- ggplot(combined_predictions, aes(x = Actual, y = Predicted - Actual, color = Model)) +
  geom_point() +
